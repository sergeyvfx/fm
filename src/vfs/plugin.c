...
/**
 * Free allocated memory and opened descriptors
 *
...
/**
 * Load symbols from library to plugin descriptor
 *
...
/**
 * Create plugin descriptor from file name of library
 *
 ...
 */
static vfs_plugin_t*
plugin_from_file (const wchar_t *__file_name, int *__error)
{
  vfs_plugin_t *plugin;
  int err;
  ...
  /*
   * TODO: But does we really need this information?
   */
 ...
 * Deleter of a plugin
 *
 * @param __plugin - plugin to be deleted
 */
static void
